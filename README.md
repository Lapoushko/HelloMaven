...
### Выполнение второго задания:
  ...
  5 - Можно выполнить force push или удалить ветку ![2023-10-11_19-31-39](https://github.com/Lapoushko/HelloMaven/assets/45125347/a7326944-2814-49df-a579-52e285636e59)
...
<br/>Нельзя ветку запушить, поскольку у коммита создания файла на локальной и на удалённой ветке разные хэши, тогда при пуше возникла ошибка.</br>
<br/>Есть два способа запушить ветку: просто удалить remote ветку и запушить локальную в remote. Или сделать force push от локальной ветки на удалённую. Я воспользовался вторым вариантом с force-push</br>
